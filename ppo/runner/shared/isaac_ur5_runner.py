...
class IsaacRunner_UR5(Runner):
    """Runner class to perform training, evaluation. and data collection for SMAC. See parent class for details."""
    def __init__(self, config):
        super(IsaacRunner_UR5, self).__init__(config)
        self.reward_list = []
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                data = obs, rewards, dones, infos, \
                       values, actions, action_log_probs, obs_img
    ...
    def insert(self, data):
        ...
        values, actions, action_log_probs, obs_img = data
        ...
        self.buffer.insert(obs, actions, action_log_probs, values, rewards, masks, active_masks, obs_img=obs_img)
