...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mat', choices=["mat", "mat_dec", "mat_encoder", "mat_decoder", "mat_gru", "mat_gnn"])
    ...
    #parser.add_argument("--model_dir", type=str, default='/home/shahils/Desktop/marl_ws/Multi-Agent-Transformer/mat/scripts/results/mujoco/HalfCheetah-v5/mat_gnn/single/wandb/run-20250331_095305-uvnda27b/files/transformer_100.pt', help="by default None. set the path to pretrained model.")
