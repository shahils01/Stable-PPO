...
CUDA_VISIBLE_DEVICES=0 python train/train_smac_multi.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --train_maps ${train_maps} --eval_maps ${eval_maps} --seed ${seed} --n_training_threads 8 --n_eval_rollout_threads 18 --n_rollout_threads 18 --num_mini_batch 1 --episode_length 100 --num_env_steps 10000000 --lr 5e-4 --ppo_epoch 10 --clip_param 0.05 --use_value_active_masks --use_eval
