...
CUDA_VISIBLE_DEVICES=0 python train/eval_isaac.py \
 --seed ${seed} \
 --env_name ${env} \
 --algorithm_name ${algo} \
 --experiment_name ${exp} \
 ...
 --model_dir "/home/i2r/shahil_ws/Stable-PPO/ppo/scripts/results/mujoco/GoToGoal-v0/ppo/run34/models/transformer_15624.pt" \
